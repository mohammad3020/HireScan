      ...
      <div className="max-w-md w-full">
        ...
        <div className="card p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label htmlFor="password2" className="block text-sm font-medium text-gray-800 mb-2">
          ...
          <div className="mt-6 text-center text-sm text-gray-700">
            <p>
              ...
              <Link to="/login" className="text-gray-800 font-medium hover:text-gray-900 underline">
                Sign In
              </Link>
            </p>
          </div>
