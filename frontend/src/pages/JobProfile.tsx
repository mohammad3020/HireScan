      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <aside className="space-y-6">
          ...
          <section className="card space-y-4 p-6">
            ...
            <div className="space-y-3 text-sm text-gray-700">
              <p>
                This page is view-only. To update the job details, return to the Jobs dashboard
                and choose the edit option.
              </p>
              <div className="flex flex-col space-y-2">
                <Link to={`/jobs/${job.id}`} className="btn-secondary text-center">
                  Edit job (mock)
                </Link>
                <Link to={`/review?jobId=${job.id}`} className="btn-primary text-center">
                  Review candidates
                </Link>
              </div>
            </div>
